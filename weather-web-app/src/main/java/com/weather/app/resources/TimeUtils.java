...
public class TimeUtils {
    ...
    public static String convertUnixTimeToSimpleDateTimeFormat(String unixTime, String timeZone) {
	String date = null;

	DateTimeFormatter formatter = DateTimeFormatter.ofPattern(SIMPLE_DATE_TIME_FORMAT);
    ...
    public static String getTimeFromUnixTime(String unixTime, String timeZone) {
	String date = null;

	DateTimeFormatter formatter = DateTimeFormatter.ofPattern(SIMPLE_TIME_FORMAT);
	LocalDateTime dateTime = getLocalDateTimeFromUnixTime(unixTime, timeZone);
	if (dateTime != null) {
	    date = dateTime.format(formatter);
	}
    ...
    public static String getDateFromUnixTime(String unixTime, String timeZone) {
	String date = null;
